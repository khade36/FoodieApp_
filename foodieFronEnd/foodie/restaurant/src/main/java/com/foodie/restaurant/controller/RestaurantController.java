...
public class RestaurantController {
    ...
    public ResponseEntity<?> saveRestoOwner(@RequestBody RestoOwner restoOwner) throws RestaurantOwnerAlreadyExistException {
    ...
    @GetMapping("restaurant/getAllRestOwners")
    public ResponseEntity<?> getAllRestoOwners( HttpServletRequest request)
    {
    ...
    public ResponseEntity<?> updatePrice(@PathVariable String restaurantName,@PathVariable String itemName,@RequestBody int newPrice, HttpServletRequest request)  throws  RestoOwnerNotFoundException,RestaurantNotFoundException,ItemNotFoundException
    {
        try {
            System.out.println("header" + request.getHeader("Authorization"));
            Claims claims = (Claims) request.getAttribute("claims");
