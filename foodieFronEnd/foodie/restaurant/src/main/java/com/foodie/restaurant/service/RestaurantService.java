...
public interface RestaurantService {
    RestoOwner saveRestoOwnerToList(RestoOwner restoOwner) throws RestaurantOwnerAlreadyExistException;
    ...
    Restaurant updateItem(String ownerId,String restaurantName,String itemName,int newPrice) throws RestoOwnerNotFoundException, RestaurantNotFoundException, ItemNotFoundException;
}
