...
@Autowired
    ...
    public ResponseEntity<?> saveUser(@RequestBody User user)  {
        try {
            responseEntity = new ResponseEntity<>(userFavService.saveUser(user), HttpStatus.CREATED);
        }
    ...
    @GetMapping("user/getFavRestList")
    ...
    @GetMapping("user/getFavItemList")
